...
### 1️⃣ The graph is a platform concern, not an ingestion concern
...
### 2️⃣ Enforces correct service boundaries

After the change:

```
shared      → schema + contracts
ingestion   → writes graph
...
### 4️⃣ Prepares for Future Platform Expansion
...
### ❌ Option A: Keep models inside ingestion_service
...
### ❌ Option B: Duplicate models in orchestrator
...
### ❌ Option C: Orchestrator fetches graph via ingestion API
